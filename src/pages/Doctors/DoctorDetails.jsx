        ...
        <div className='grid md:grid-cols-3 gap-12'>
          <div className='md:col-span-2'>
            <div className='flex items-center gap-5'>
              ...
              <div>
                <span
                  className='bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>Surgeon</span>
                <h3 className='text-headingColor text-[22px] leading-9 font-bold mt-3'>Dr. Saleh Mahmud</h3>
