            ...
            <form>
              ...
              <div className='mb-5 flex items-center justify-between'>
                <label className='text-textColor text-[16px] leading-7 cursor-pointer'>
                  Are you a : <select name='role' className='text-[15px] leading-7 px-4 py-3 text-headingColor focus:outline-none'>
                    <option value="patient">Patient</option>
                    <option value="doctor">Doctor</option>
                  </select>
                </label>
                <label className='text-textColor text-[16px] leading-7 cursor-pointer'>
                  Select Gender : <select name='role' className='text-[15px] leading-7 px-4 py-3 text-headingColor focus:outline-none'>
              ...
              <div className='mb-5 flex items-center gap-3'>
                <figure className='w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center'>
                  ...
                  <div className='relative w-[130px] h-[50px]'>
                      <input type='file' name='avatar' id='avatar' className='absolute top-5 left-0 w-full h-full opacity-0 cursor-pointer' accept='.jpg, .png, .jpeg' />
